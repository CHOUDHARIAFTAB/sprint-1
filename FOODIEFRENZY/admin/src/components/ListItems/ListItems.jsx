                    ...
                    id} className={styles.tr}>
                      ...
                      <td className={styles.nameCell}>
                        <div className="space-y-1">
                          <p className={styles.nameText}>{item.
// @ts-ignore
                          name}</p>
                          <p className={styles.descText}>{item.
// @ts-ignore
                          description}</p>
                        </div>
                      </td>
                      <td className={styles.categoryCell}>{item.
// @ts-ignore
                      category}</td>
                      <td className={styles.priceCell}>₹{item.
// @ts-ignore
                      price}</td>
                      <td className={styles.ratingCell}>
                        <div className="flex gap-1">{renderStars(item.
// @ts-ignore
                        rating)}</div>
                      </td>
